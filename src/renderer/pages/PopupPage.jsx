...
const PopupPage = () => {
  ...
  return (
    <div 
      ref={popupRef} 
      className="flex flex-col bg-background/95 backdrop-blur-xl animate-in fade-in-0 zoom-in-95 duration-300 scrollbar-none" 
    ...
    >
      ...
      {/* Input Area */}
      <div className={cn("bg-background/95 backdrop-blur-sm rounded-b-3xl sticky bottom-0", {
